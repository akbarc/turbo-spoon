...
if st.session_state.selected_group is None:
    ...
    with col4:
        if group_data.get('pd_checks_total', 0) > 0:
    ...
    with col5:
        st.metric("Transactions", f"{group_data['transaction_count']:,}")
    ...
    for store in stores_sorted:
        # Build title without nested f-strings
        ...
        with st.expander(title, expanded=False):
            ...
            with col4:
                if store.get('pd_checks_total', 0) > 0:
